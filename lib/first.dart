                  ...
                  child: Stack(
                    ...
                    children: [
                      Container(
                          ...
                          width: 330,
                          height: 220,
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(30), color: const Color.fromRGBO(251, 83, 117, 1)),
                          child: const Align(
                  ...
                  child: Stack(
                    ...
                    children: [
                      Container(
                          ...
                          width: 330,
                          height: 220,
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(30), color: const Color.fromRGBO(69, 134, 201, 1)),
                          child: const Align(
                            alignment: Alignment.bottomCenter,
                            // ignore: prefer_const_constructors
                            child: Text("Quiz",
